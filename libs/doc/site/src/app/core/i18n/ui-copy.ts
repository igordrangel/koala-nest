...
export const UI_COPY = {
  pt: {
    ...
    searchEmptyHint: 'Digite para buscar páginas da documentação',
    ...
    footer: {
      ...
      quickCommandsList: [
        ...
        'kl-nest new',
        'kl-nest add cache',
        'bun run start:dev  # migrations no boot',
        'kl-nest --help',
      ],
  ...
  en: {
    ...
    searchEmptyHint: 'Type to search documentation pages',
    ...
    footer: {
      ...
      quickCommandsList: [
        ...
        'kl-nest new',
        'kl-nest add cache',
        'bun run start:dev  # migrations on boot',
        'kl-nest --help',
      ],
