...
Crie um `.env` na raiz do projeto (veja também `.env.example`):
...
A camada de infraestrutura acessa variáveis tipadas via `EnvService`, injetado no factory do DataSource:
