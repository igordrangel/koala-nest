...
|---------|--------|-------------------|
| `delay(ms)` | `@koalarx/utils/KlDelay` | Bootstrap (`bootstrapKoalaJobs`), loop de cron jobs, setup E2E |
...
Usado em `koala-bootstrap.ts` e `CronJobHandlerBase` para aguardar entre ciclos do job.
