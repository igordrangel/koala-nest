...
O template inclui [`@koalarx/utils`](https://utils.koalarx.com/) como dependência oficial. A biblioteca concentra validadores, conversores e operadores reutilizáveis (`KlString`, `KlDelay`, `KlDate`, `KlArray`, etc.).
